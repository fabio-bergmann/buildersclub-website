  ...
  return (
    <div className="w-full max-w-6xl mt-44">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Benefit 1 */}
        <AnimatedCard index={0} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
        ...
        {/* Benefit 2 */}
        <AnimatedCard index={1} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#3478F2] to-[#2663EB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#1E40AF] transform transition-all duration-150">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
        ...
        {/* Benefit 3 */}
        <AnimatedCard index={2} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#3478F2] to-[#2663EB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#1E40AF] transform transition-all duration-150">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
        ...
        {/* Benefit 4 */}
        <AnimatedCard index={3} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#3478F2] to-[#2663EB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#1E40AF] transform transition-all duration-150">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
        ...
        {/* Benefit 5 */}
        <AnimatedCard index={4} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#3478F2] to-[#2663EB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#1E40AF] transform transition-all duration-150">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
        ...
        {/* Benefit 6 */}
        <AnimatedCard index={5} className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
          <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#3478F2] to-[#2663EB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#1E40AF] transform transition-all duration-150">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
