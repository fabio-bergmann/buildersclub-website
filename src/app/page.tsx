                    ...
                    <div className="flex-1 space-y-3">
                      ...
                      <div className={`flex justify-between items-center transition-all duration-300 delay-200 ${
                        ...
                        <div className="flex space-x-3">
                          ...
                          <button 
                            onClick={handlePost}
                            className="px-6 py-2 bg-gradient-to-b from-[#3D3D3D] to-[#2B2B2B] text-white text-sm font-medium rounded-lg hover:from-[#333333] hover:to-[#202020] transition-colors duration-200"
                          >
                            Post
                          </button>
                        </div>
            ...
            <div className="hidden lg:flex items-center space-x-3 w-full">
              <button 
                ...
                className={`px-6 py-3 border rounded-xl text-sm font-medium flex-1 text-center transition-colors duration-200 cursor-pointer ${
                  activeCategory === 'All' 
                    ? 'bg-gradient-to-b from-[#3D3D3D] to-[#2B2B2B] text-white border-[#2B2B2B]' 
      ...
      <div className="w-full max-w-6xl mt-44">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#4A90FF] to-[#0406FB] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#0406FB] transform transition-all duration-150">
          ...
          {/* Benefit 2 */}
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#F9DF28] to-[#F9C052] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#F9C052] transform transition-all duration-150">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
          ...
          {/* Benefit 3 */}
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#F35707] to-[#F44A13] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#F44A13] transform transition-all duration-150">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
          ...
          {/* Benefit 4 */}
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#F11B5D] to-[#D61353] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#D61353] transform transition-all duration-150">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
          ...
          {/* Benefit 5 */}
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#93C065] to-[#61AD7E] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#61AD7E] transform transition-all duration-150">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
          ...
          {/* Benefit 6 */}
          <div className="bg-white rounded-2xl shadow-xs border border-gray-200 p-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-b from-[#CB3C5F] to-[#9A3189] flex items-center justify-center mb-4 shadow-[0_3px_0_0_#9A3189] transform transition-all duration-150">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-white">
